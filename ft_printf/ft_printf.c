...
/*   Updated: 2023/11/23 12:37:46 by dpoltura         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    while (*format)
    {
        while (*format == '%')
        {
            ...
            else if (*(format) == 'p')
            {
                ...
                j += ft_putstr_fd("0x", 1);
                j += ft_putnbr_base_fd(va_arg(args, long), "0123456789abcdef", 1);
            }
            else if (*(format) == 'i')
                ...
                j += ft_putnbr_base_fd(va_arg(args, int), "0123456789abcdef", 1);
            else if (*(format) == 'X')
